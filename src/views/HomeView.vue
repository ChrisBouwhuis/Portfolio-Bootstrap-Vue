...
<template>
  <main class="container">
    <div class="d-flex flex-column align-items-center p-5">
      ...
      <h2 class="p-1 fs-4">
        Op deze website kun je meer over mij te weten komen en enkele voorbeelden zien van projecten
        die ik in het verleden heb afgerond.
      </h2>
    </div>
    <div class="d-flex flex-column align-items-center">
      <h1 class="text-decoration-underline p-2">Wie ben ik?</h1>
      <div class="row d-flex flex-column flex-xl-row justify-content-center align-items-center align-items-xl-start">
        <div class="col-12 col-xl-8 order-1 order-xl-2">
          <p class="fs-4 p-3">
            ...
            >
              dorp Boekelo</a
            >. Ik ben student aan het
            <a
              href="https://www.rocvantwente.nl/voor-scholieren/mbo-opleidingen/software-developer-bol-4.html"
            >
              ROC van Twente</a
